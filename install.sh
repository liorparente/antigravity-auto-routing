...
TARGET_DIR="$HOME/.gemini/config/skills/auto-routing"
...
# 1. Ensure target config directory exists
...
# 3. Make audit script executable
...
echo "   Skill files:   $TARGET_DIR"
echo "   Protocol doc:  $GEMINI_MD"
echo "   Run audits with: $TARGET_DIR/routing-audit.sh [conversation-id]"
