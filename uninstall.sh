...
for target_dir in "${TARGET_DIRS[@]}"; do
    if [ -d "$target_dir" ]; then
        rm -f "$target_dir/SKILL.md" "$target_dir/REFERENCE.md" "$target_dir/routing-audit.sh" "$target_dir/routing_check.py" "$target_dir/agent_council.py" "$target_dir/routing-config.json" "$target_dir/protocol.md"
