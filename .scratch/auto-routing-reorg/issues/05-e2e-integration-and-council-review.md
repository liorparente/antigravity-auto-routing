...
## Acceptance criteria
- [ ] 100% of unit and integration tests pass with zero regressions.
- [ ] `install.sh` cleanly synchronizes all three AI harnesses (`~/.gemini/`, `~/.codex/`, `.agents/`).
- [ ] Real-world test task verifies end-to-end execution, local model probing, and automatic outcome recording.
- [ ] Multi-agent `Council Review` panel returns unanimous approval.
