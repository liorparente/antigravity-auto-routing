# 01 — Architecture Contracts ADR & Domain Glossary Alignment

**What to build:** Formalize the core Workflow V2 contracts (Harness, Orchestrator, Role, Capability Requirements, Provider, Model, Worker, Context Layer, Perspective Reviewer) in docs/adr/0012-workflow-v2-architecture-contracts.md and update CONTEXT.md with the formal definitions.
