...
- Lesson: "I verified the report" is only as strong as the weakest claim in it, and partial verification produces confidence proportional to what was checked rather than to what was left. Count the claims, mark which were tested, and say so — "four of five verified" is an honest report; "verified" is not.
